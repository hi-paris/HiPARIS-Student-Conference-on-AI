...
A submission is a **blog post** (one Markdown page rendered on this website), written in
**English**, backed by a **public GitHub repository** containing the code, documentation,
license, and reproduction instructions. The recommended length is **2,500–3,500 words**
(hard limit: 6,000), plus an optional **appendix of unlimited length**. The official
submission is the web page — not a PDF.

See the [submission guidelines]({{ '/submitting/' | relative_url }}) for the step-by-step
instructions, and the sample post to start from.

# Review and decisions

- Review is **double blind**: submissions are anonymized until decisions.
- Each submission receives **at least two reviews**, following public criteria: quality,
  clarity, correctness, and whether the project's context and approach are made explicit.
- **Every submitting author reviews two submissions** — learning to review is part of the
  conference. See the [reviewer guidelines]({{ '/reviewing/' | relative_url }}).
- Decisions are **accept or reject**, taken by the area chairs together with the senior
  academic committee — see the [committee]({{ '/committee/' | relative_url }}) page for
  who decides what and how conflicts are handled. Among accepted submissions, the
  committee selects **posters and orals** for the conference program.

# Awards

Prizes will be awarded in several categories, decided by the scientific committee of

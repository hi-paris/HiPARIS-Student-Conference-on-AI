...
**Submit** your blogpost on [Openreview](https://openreview.net/group?id=ICLR.cc/2026/BlogPosts).
...
The posts will be created and published under a unified template; see [the submission instructions]({{ '/submitting' | relative_url }}) and the [sample post]({% post_url 2026-04-28-my-blog-post %}) hosted on the blog of this website.
